...
public class WWSClientArgs {
  ...
  private static final Parameter[] PARAMETERS = new Parameter[] {
      new FlaggedOption("server", JSAP.STRING_PARSER, JSAP.NO_DEFAULT, JSAP.REQUIRED, 's', "server",
          "Remote server."),
      new FlaggedOption("port", JSAP.INTEGER_PARSER, "16022", JSAP.NOT_REQUIRED, 'p', "port",
          "Remote port."),
      new FlaggedOption("command", JSAP.STRING_PARSER, JSAP.NO_DEFAULT, JSAP.NOT_REQUIRED,
          JSAP.NO_SHORTFLAG, "command", "Command string."),
      ...
      new FlaggedOption("rsamPeriod", JSAP.INTEGER_PARSER, "300", JSAP.NOT_REQUIRED,
          JSAP.NO_SHORTFLAG, "rsamPeriod", "RSAM period."),
  ...
  /** Send provided command directly to wave server and return result to <STDOUT> */
  ...
  public WWSClientArgs(final String[] commandLineArgs) throws Exception {
    ...
    command = jsapResult.getString("command");
